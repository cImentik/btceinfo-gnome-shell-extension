...
const BtceInfoSettingsWidget = new GObject.Class({
  Name: "BtceInfo.BtceInfoSettingsWidget",
  GTypeName: "BtceInfoSettingsWidget",
  Extends: Gtk.Box,
...
function buildPrefsWidget() {
  let widget = new BtceInfoSettingsWidget();
